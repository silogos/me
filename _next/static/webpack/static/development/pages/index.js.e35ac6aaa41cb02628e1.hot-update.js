...
function WorkExperiences() {
  ...
  return __jsx("article", {
    ...
    style: {
      flex: 0.65,
      height: 'calc(65% * 1.4277777777777778)',
      flexDirection: 'column',
      padding: '20px 15px',
      marginBottom: '15px',
      borderRadius: '15px',
  ...
  }, _datas_portfolio__WEBPACK_IMPORTED_MODULE_4__["default"][0].projets.slice(0, 2).map(function (item) {
...
//# sourceMappingURL=index.js.e35ac6aaa41cb02628e1.hot-update.js.map